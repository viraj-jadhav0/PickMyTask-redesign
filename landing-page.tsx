...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#029791] via-[#027368] to-black text-white overflow-hidden">
      {/* Hero Section */}
      <div
        ref={heroRef}
      ...
      >
        <div className="text-center max-w-4xl mx-auto">
          <div
            className={`inline-block mb-8 transition-all duration-700 delay-300 ${
              isVisible.hero ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
            }`}
          >
            <span className="text-[#029791] bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium tracking-wider uppercase border border-white/20">
              How it works
            </span>
          </div>
          ...
          <p
            className={`text-xl md:text-2xl text-gray-300 mb-8 transition-all duration-700 delay-700 ${
              isVisible.hero ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
            }`}
          >
          ...
          <div
            className={`w-20 h-1 bg-[#029791] mx-auto rounded-full transition-all duration-700 delay-900 ${
      ...
      {/* Steps Section */}
      <div ref={stepsRef} className="min-h-screen flex items-center justify-center px-4 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              >
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 h-full hover:bg-white/10 hover:border-[#029791]/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#029791]/20">
                  <div className="flex flex-col items-center text-center">
                    <div className="w-16 h-16 bg-[#029791] rounded-full flex items-center justify-center mb-6 text-2xl font-bold shadow-lg shadow-[#029791]/30 group-hover:scale-110 transition-transform duration-300">
                      {step.number}
                    </div>
                    <h3 className="text-2xl font-bold mb-4 group-hover:text-[#029791] transition-colors duration-300">
                      {step.title}
                    </h3>
